    ...
    <div className="page-stack">
        ...
        <article className="panel ranking-card">
          <div className="section-heading">
            <div>
              ...
              <p>Top performansi teknisi berdasarkan akumulasi close tiket reguler, sqm dan unspec.</p>
            </div>
          </div>
      ...
      <section className="split-grid">
        <article className="panel table-panel">
          <div className="section-heading">
            <div>
              ...
              <p>Top performansi team dari pekerjaan tiket reguler, tiket SQM, dan unspec.</p>
            </div>
          </div>
        ...
        <article className="panel spotlight-card">
          ...
          <p>
            {topTeam
              ? `${topTeam.team} memimpin dengan ${topTeam.close} close pekerjaan produktivitas harian teknisi ${topTeam.productivity}%.`
